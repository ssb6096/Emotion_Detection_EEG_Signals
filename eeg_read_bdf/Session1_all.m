%Detection of mental state of a human using 
for main_loop_counter=1:1:3
clearvars -except main_loop_counter
    
%% Extracting EEG Signals
%Participant-1/session-1 %NOT CONSIDERED, DIFFERENT SAMPLING FREQUENCY
%[data,numChan,labels,txt,fs,gain,prefiltering,ChanDim] 
%= eeg_read_bdf('eNTERFACE06_EMOBRAIN\Data\EEG\','all','n')
% % Participant1, session 1
% m = csvread('eNTERFACE06_EMOBRAIN\Data\EEG\Part1_IAPS_SES1_EEG_fNIRS_03082006.bdf.mrk.csv')
switch main_loop_counter
    
%Participant-2/session-1
%[data,numChan,labels,txt,fs,gain,prefiltering,ChanDim1] = eeg_read_bdf('eNTERFACE06_EMOBRAIN\Data\EEG\Part2_IAPS_SES1_EEG_fNIRS_07082006.bdf','all','n')
% %Participant-2/session-1
%m = csvread('eNTERFACE06_EMOBRAIN\Data\EEG\Part2_IAPS_SES1_EEG_fNIRS_07082006.bdf.mrk.csv')    
    case 1
%Participant-3/session-1
[data,numChan,labels,txt,fs,gain,prefiltering,ChanDim1] = eeg_read_bdf('eNTERFACE06_EMOBRAIN\Data\EEG\Part3_IAPS_SES1_EEG_fNIRS_07082006.bdf','all','n')
%Participant-3/session-1
m = csvread('eNTERFACE06_EMOBRAIN\Data\EEG\Part3_IAPS_SES1_EEG_fNIRS_07082006.bdf.mrk.csv')   
    case 2
...
% %Participant-4/session-1
m = csvread('eNTERFACE06_EMOBRAIN\Data\EEG\Part4_IAPS_SES1_EEG_fNIRS_07082006.bdf.mrk.csv')    
    case 3 
%Participan-5/session-1  
...
m = csvread('eNTERFACE06_EMOBRAIN\Data\EEG\Part5_IAPS_SES1_EEG_fNIRS_08082006.bdf.mrk.csv')
end 
...
% features8=Spectral_Features_Extract(filtered_f_data,SF)
...
%PARTICIPANT 1 SESSION1 IS NOT CONSIDERED
%save ('participant1_session1','features1','features2','features3','features_discrete_wavelet','features')
    
%save ('participant2_session1','features1','features2','features3','features_discrete_wavelet','features')
    case 1
% save ('participant3_session1','features1','features2','features3','features_discrete_wavelet','features')
% save ('participant3_session1_more','features1','features2','features3','features')
save ('participant3_session1_4_29','features1','features2','features3','features4','features5','features6','features7','features8','features9','features_discrete_wavelet','features')
    case 2
% save ('participant4_session1','features1','features2','features3','features_discrete_wavelet','features')
% save ('participant4_session1_more','features1','features2','features3','features')
save ('participant4_session1_4_29','features1','features2','features3','features4','features5','features6','features7','features8','features9','features_discrete_wavelet','features')
    case 3
% save ('participant5_session1','features1','features2','features3','features_discrete_wavelet','features')
% save ('participant5_session1_more','features1','features2','features3','features')
save ('participant5_session1_4_29','features1','features2','features3','features4','features5','features6','features7','features8','features9','features_discrete_wavelet','features')
end
end